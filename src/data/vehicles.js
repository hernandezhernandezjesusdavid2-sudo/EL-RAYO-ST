...
const generateVehicles = () => {
  ...
  carModels.forEach((model, i) => {
    list.push({
      ...
      price: `$${(25 + i * 5)},000`,
      mainImage: '/images/car.png',
      gallery: ['/images/car.png', '/images/car_int.png'],
  ...
  motoModels.forEach((model, i) => {
    list.push({
      ...
      engine: `${600 + i * 50}cc`,
      price: `$${(8 + i * 2)},500`,
      mainImage: './images/moto.png',
      gallery: ['./images/moto.png', './images/moto_detail.png'],
...
export const services = [
  {
    ...
    problem: '¿Luces en el tablero o fallas misteriosas?',
    solution: 'En EL RAYO detectamos la falla exacta con tecnología de punta en minutos.'
  },
  {
    title: 'Mantenimiento Preventivo',
    problem: '¿Quieres evitar reparaciones costosas?',
    solution: 'Cuidamos cada detalle para que tu vehículo nunca te deje a pie.'
  },
  {
    title: 'Reparación de Motores',
    problem: '¿Pérdida de potencia o ruidos extraños?',
    solution: 'Expertos certificados devuelven la vida y el rendimiento a tu motor.'
  }
];
